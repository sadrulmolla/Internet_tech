...
Already registered? <a href="http://localhost:8090/air-line/logincustomer.jsp">Customer Login</a>
<br>
<form action="registercustomer" method="post" style="position: absolute; /*or fixed*/; width: 50%; height: 300px; left: 50%; top:100px; margin: 0 0 0 -25%">
